...
@section('dashboard-content')
    ...
    <form action="{{ URL::to('update-book') }}/{{ $book->id }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="form-group">
            <label for="exampleInputEmail1"> Book name</label>
            <input type="text" class="form-control" value="{{ $book->book_name }}" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter book name" name="book_name">
        </div>
        <div class="form-group">
